...
def annotate(estimator, dataloader, option, modalities):
    estimator.eval()
...
def main():
    ...
    print()
    print("Metricas da pasta ", opt.outf)
    ...
    annotate(estimator, dataloader, option, modalities)
